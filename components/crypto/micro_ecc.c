...
void ecc_point_compress_bytes(uint8_t p_compressed[NUM_ECC_DIGITS*4 + 1], uint8_t p_uncompressed[NUM_ECC_DIGITS*8 + 1])
{
    EccPoint point;
    EccPoint * p_point = &point;
    ecc_bytes2native(p_point->x, p_uncompressed + 1);
    ecc_bytes2native(p_point->y, p_uncompressed + NUM_ECC_DIGITS*4 + 1);
    ecc_point_compress(p_compressed, p_point);
}
...
void ecc_point_decompress_bytes(uint8_t p_uncompressed[NUM_ECC_DIGITS*8 + 1], uint8_t p_compressed[NUM_ECC_DIGITS*4 + 1])
{
    EccPoint point;
    EccPoint * p_point = &point;
    ecc_bytes2native(p_point->x, p_compressed + 1);
    ...
    ecc_native2bytes(p_uncompressed + 1, p_point->x);
    ecc_native2bytes(p_uncompressed + 33, p_point->y);
    p_uncompressed[ 0 ] = 0x04;
}
